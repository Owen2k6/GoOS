...
namespace GoOS.Virtualisation.ChaOS
{
    public class Kernel : VM
    {
        ...
        public const string copyright = "Copyright (c) 2022 Kastle Grounds";
        ...
        protected override void Run()
        {
            ...
            try
            {
                ...
                else if (input == "sysinfo")
                {
                    ...
                    log(" System RAM: " + Cosmos.Core.GCImplementation.GetUsedRAM() + "MB used out of " + Cosmos.Core.CPU.GetAmountOfRAM() + "MB\n");
                }
