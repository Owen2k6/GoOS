...
public static class LZW
{
    ...
    public static byte[] LZWCompress(byte[] Binary)
    {
        ...
        for (var I = 0; I < 256; I++) Dictionary.Add(((char)I).ToString(), I);

        for (var I = 0; I < Binary.Length; I++)
        {
            var WC = W + (char)Binary[I];
        ...
        var ReturnBytes = new byte[Compressed.Count * sizeof(int)];
    ...
    public static byte[] LZWDecompress(byte[] Binary)
    {
        ...
        var CompressedTemp = new int[Binary.Length * sizeof(char)];
        Buffer.BlockCopy(Binary, 0, CompressedTemp, 0, CompressedTemp.GetLength(0));
        List<int> Compressed = new();
        for (var I = 0; I < CompressedTemp.Length; I++) Compressed.Add(CompressedTemp[I]);

        // build the dictionary
        for (var I = 0; I < 256; I++) Dictionary.Add(I, ((char)I).ToString());
