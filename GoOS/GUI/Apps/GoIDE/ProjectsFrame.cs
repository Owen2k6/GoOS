...
public class ProjectsFrame : Window
{
    ...
    private readonly Button LoadExistingButton;
    private readonly Button[] RecentProjectsButtons;
    ...
    public ProjectsFrame()
    {
        try
        {
            ...
            var recentProjects = Directory.GetFiles(@"0:\content\prf\GoIDE\Projects\");
            ...
            for (var i = 0; i < recentProjects.Length; i++)
                RecentProjectsButtons[i] = new Button(this, Convert.ToUInt16(10 + i / 10 * 185),
                    Convert.ToUInt16(52 + (i * 20 - i / 10 * 200)), Convert.ToUInt16(recentProjects[i].Length * 8), 20,
                    recentProjects[i])
                {
            ...
            DeleteButton =
                new Button(this, Convert.ToUInt16(Contents.Width - 380), Convert.ToUInt16(Contents.Height - 30), 64, 20,
                    "Delete") { Clicked = DeleteButton_Click };
            ImportButton =
                new Button(this, Convert.ToUInt16(Contents.Width - 306), Convert.ToUInt16(Contents.Height - 30), 64, 20,
                    "Import") { Clicked = ImportButton_Click };
            LoadExistingButton =
                new Button(this, Convert.ToUInt16(Contents.Width - 234), Convert.ToUInt16(Contents.Height - 30), 120,
                    20, "Load existing") { Clicked = LoadExistingButton_Click };
            CreateNewButton =
                new Button(this, Convert.ToUInt16(Contents.Width - 106), Convert.ToUInt16(Contents.Height - 30), 96, 20,
    ...
    private void RecentProjects_Click(string i)
    {
        ...
        {
            WindowManager.AddWindow(new IDEFrame(i.Remove(i.LastIndexOf(".")), @"0:\content\prf\GoIDE\Projects\" + i,
                i.EndsWith(".9xc")));
            Dispose();
        }
    }
