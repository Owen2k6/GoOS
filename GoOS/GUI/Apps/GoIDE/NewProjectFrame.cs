...
{
    private readonly Button _9xCodeButton;
    private readonly Button CancelButton;
    private readonly Button CreateButton;
    private readonly Button GoCodeButton;
    private readonly Input ScriptLocation;

    private readonly Input ScriptName;
        ...
        try
        {
            ...
            CreateButton =
                new Button(this, Convert.ToUInt16(Contents.Width - 180), Convert.ToUInt16(Contents.Height - 30), 80, 20,
                    "Create") { Clicked = CreateButton_Click };
            CancelButton =
            ...
            GoCodeButton = new Button(this, 100, 112, 80, 20, "GoCode")
                { Clicked = GoCodeButton_Click, AppearPressed = true };
            _9xCodeButton = new Button(this, 190, 112, 80, 20, "9xCode")
                { Clicked = _9xCodeButton_Click, AppearPressed = false };
            ScriptName = new Input(this, 100, 52, Convert.ToUInt16(Contents.Width - 110), 20, "Project1");
            ScriptLocation = new Input(this, 100, 82, Convert.ToUInt16(Contents.Width - 110), 20,
    ...
    private void CreateButton_Click()
    {
        ...
        var location = ScriptLocation.Text;
        ...
        WindowManager.AddWindow(new IDEFrame(name, location + name + (GoCodeButton.AppearPressed ? ".gexe" : ".9xc"),
            _9xCodeButton.AppearPressed ? true : false));
        Dispose();
    }
    ...
    private void GoCodeButton_Click()
    {
    ...
    private void _9xCodeButton_Click()
    {
        // Toggle the GoCode and 9xCode buttons
