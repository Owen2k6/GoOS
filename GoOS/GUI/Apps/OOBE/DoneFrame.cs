...
public class DoneFrame : Window
{
    ...
    public DoneFrame()
    {
        ...
        Contents.DrawString(20, 40,
            "We just need to restart the system in order to apply settings and load the OS fully!\nOnce you've restarted, You will be welcomed to the GoOS Desktop!",
            Font_1x, Color.White);
