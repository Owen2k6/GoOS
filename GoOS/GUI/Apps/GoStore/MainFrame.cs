...
public class MainFrame : Window
{
    ...
    public MainFrame()
    {
        ...
        {
            _abortOpen = true;
            Dialogue.Show("Error - GoStore", "GoStore services are not available at the moment.", default,
                WindowManager.errorIcon);
            Visible = false;
            Closing = true;
            return;
    ...
    private void LoadData()
    {
        ...
        catch (HttpHelper.RegionBlockedException ex)
        {
            ...
            Dialogue.Show("GoStore", _regionBlocked ? _regionBlockReason : "Service unavailable.", default,
                WindowManager.errorIcon);
    ...
    private void Render(string category)
    {
        ...
        var contentW = Contents.Width - SIDEBAR_W;
        var contentH = Contents.Height - HEADER_H - FOOTER_H;
        ...
        for (var i = page * 18; i < Math.Min(_repoFiles.Count, page * 18 + 18); i++)
        {
            ...
            var x = gridLeft + Colum * (cardW + gap);
