...
public class NewFolderFrame : Window
{
    private Button OK;
    ...
    public NewFolderFrame(string lcdir)
    {
        cdir = lcdir;

        Contents = new Canvas(300, 80);
        Title = "New Folder - Gosplorer";
        Visible = true;
        Closable = false;
        Unkillable = false;
        ...
        Contents.DrawString(5, 5, "Please input folder name:", Resources.Font_1x, Color.White);
    }
