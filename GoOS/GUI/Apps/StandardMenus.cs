...
public static class StandardMenus
{
        ...
        Action replaceAction = null)
    {
        ...
        if ((undoAction != null || redoAction != null) &&
            (cutAction != null || copyAction != null || pasteAction != null))
            items.Add(Menubar.MenuItem.Separator());
        ...
        Dictionary<string, Action> additionalViewOptions = null)
    {
        ...
        if (additionalViewOptions != null && additionalViewOptions.Count > 0)
        {
            ...
            foreach (var option in additionalViewOptions) items.Add(new Menubar.MenuItem(option.Key, option.Value));
        }
    ...
    public static Menubar.MenuModel CreateGoOSMenu(Window parentWindow)
    {
        ...
        {
            new("About GoOS", () => WindowManager.AddWindow(new About())),
            new("Check for Updates", Menubar.CheckForUpdates),
            Menubar.MenuItem.Separator(),
            new("System Settings...", () => WindowManager.AddWindow(new Frame())),
            Menubar.MenuItem.Separator(),
